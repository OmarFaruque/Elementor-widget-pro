...
defined('UNLIMITED_ELEMENTS_INC') or die('Restricted access');
   ...
   class UniteProviderAdminUC extends UniteCreatorAdmin{
		...
		protected function isInsidePlugin(){
			...
			if($page == "addon-library-layouts_layout")
				return(true);
		...
		private static function a_MENU(){}
		...
		private static function a_IMPORT_ADDONS(){}
		 ...
		 */
		protected static function setPermissionEditor(){
			
			$this->capability = "edit_posts";
		}
		
		
		private static function a_OTHERS(){}
