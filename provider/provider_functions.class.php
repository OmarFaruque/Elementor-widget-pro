...
class UniteProviderFunctionsUC{
	...
	*/
	...
	public static function a_SCRIPTS(){}
	...
	public static function addScript($handle, $url, $inFooter = false, $deps = array()){
		...
		wp_register_script($handle , $url, $deps, false, $inFooter);
	...
	*/
	...
	public static function a_SANITIZE(){}
	...
	private static function a_UPDATE_PLUGIN(){}
 ...
 */
  private static function uploadFileCodeToMessage($code) 
	...
	public static function a_ACTIONS_FILTERS(){}
