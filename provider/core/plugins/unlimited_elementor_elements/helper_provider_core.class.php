...
class HelperProviderCoreUC_EL{
	...
	public static function registerPostType_UnlimitedLibrary(){
		...
		$arrLabels = array(
						'name' => __( 'Unlimited Elements Library' ,"unlimited_elementor_elements"),
						'singular_name' => __( 'Unlimited Elements Library' ,"unlimited_elementor_elements"),
						'add_new_item' => __( 'Add New Template' ,"unlimited_elementor_elements"),
						'edit_item' => __( 'Edit Template' ,"unlimited_elementor_elements"),
						'new_item' => __( 'New Template' ,"unlimited_elementor_elements"),
						'view_item' => __( 'View Template' ,"unlimited_elementor_elements"),
						'view_items' => __( 'View Template' ,"unlimited_elementor_elements"),
						'search_items' => __( 'Search Template' ,"unlimited_elementor_elements"),
						'not_found' => __( 'No Template Found' ,"unlimited_elementor_elements"),
						'not_found_in_trash' => __( 'No Template found in trash' ,"unlimited_elementor_elements"),
						'all_items' => __( 'All Templates' ,"unlimited_elementor_elements")
				);
		...
		$arrPostType =	array(
							...
							'hierarchical' => true,
							'description' => __("Unlimited Elements Template", "unlimited_elementor_elements"),
							'supports' => $arrSupports,
							//'show_in_admin_bar' => true		
					);
		
		register_post_type( Globalselementwidgetpro::POSTTYPE_UNLIMITED_ELEMENS_LIBRARY, $arrPostType);
	...
	public static function getGeneralSettingsValues(){
		...
		$arrValues = self::$operations->getCustomSettingsObjectValues(self::$filepathGeneralSettings, Globalselementwidgetpro::GENERAL_SETTINGS_KEY);
	...
	public static function onInitAction(){
		...
		if(GlobalsUC::$inDev == true){
			...
			add_post_type_support( Globalselementwidgetpro::POSTTYPE_UNLIMITED_ELEMENS_LIBRARY, 'elementor' );
		}
	...
	public static function globalInit(){
		...
		self::$urlCore = EWPHelper::pathToFullUrl(self::$pathCore);
		...
		GlobalsUC::$currentPluginTitle = Globalselementwidgetpro::PLUGIN_TITLE;
