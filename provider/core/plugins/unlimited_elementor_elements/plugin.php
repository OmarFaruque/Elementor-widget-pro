...
class elementwidgetproPluginUC extends UniteCreatorPluginBase{
	
	protected $extraInitParams = array();
	
	private $version = "1.0";
	private $pluginName = "unlimited_elementor_elements_plugin";
	private $title;
	private $description;
	...
	public function __construct(){
		...
		$this->title = esc_html__("Unlimited Elements for Elementor", "unlimited_elementor_elements");
	...
	public function runAdmin(){
		...
		$mainFilepath = GlobalsUC::$pathPlugin."unlimited_elementor_elements.php";
	...
	public function onPluginsLoaded(){
		...
		if(defined("UC_BOTH_VERSIONS_ACTIVE")){
			EWPHelper::addAdminNotice("Both unlimited elements plugins, FREE and PRO are active! Please uninstall FREE version.");
		}
	...
	private function modifyPluginVariables(){
		...
		$pluginName = Globalselementwidgetpro::PLUGIN_NAME;
	...
	protected function runCommonActions(){
		...
		$this->registerAddonType(Globalselementwidgetpro::ADDONSTYPE_ELEMENTOR, $objAddonTypeElementor);
		
		$objAddonTypeElementorTempalte = new UniteCreatorAddonType_Elementor_Template();
		$this->registerAddonType(Globalselementwidgetpro::ADDONSTYPE_ELEMENTOR_TEMPLATE, $objAddonTypeElementorTempalte);
		
		$objAddonTypeCustomPostTypes = new UniteCreatorAddonType_CustomPostType();
		$this->registerAddonType(Globalselementwidgetpro::ADDONSTYPE_CUSTOM_POSTTYPES, $objAddonTypeCustomPostTypes);
