...
class UniteCreatorDialogParamElementor extends UniteCreatorDialogParam{
	...
	protected function putTypographyParamField(){
		...
		<div class="unite-inputs-label">
			...
			<?php esc_html_e("CSS Selector", "unlimited_elementor_elements")?>:
		</div>		
		...
		<div class="unite-inputs-label">
			...
			<?php esc_html_e("CSS Selector 2 (optional)", "unlimited_elementor_elements")?>:
		</div>		
		...
		<div class="unite-inputs-label">
			...
			<?php esc_html_e("CSS Selector 3 (optional)", "unlimited_elementor_elements")?>:
		</div>		
		
		<input type="text" name="selector3" value="">
		
		<div class="unite-dialog-description-right">
			* <?php esc_html_e("The selector that the typography field will be related to. Can be related to several html tags.", "unlimited_elementor_elements")?>
		</div>
	...
	protected function filterMainParams($arrParams){
		...
		switch($this->addonType){
			case Globalselementwidgetpro::ADDONSTYPE_ELEMENTOR:
	...
	protected function initByAddonType($addonType){
		...
		if($addonType != Globalselementwidgetpro::ADDONSTYPE_ELEMENTOR)
			return(false);
