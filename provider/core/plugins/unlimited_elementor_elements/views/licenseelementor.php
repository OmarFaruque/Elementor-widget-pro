...
require EWPHelper::getPathViewObject("activation_view.class");


class elementwidgetproLicenceView extends UniteCreatorActivationView{
	...
	private function initByEnvato(){
		...
		$this->textPasteActivationKey = esc_html__("Paste your envato activation key here", "unlimited_elementor_elements");

		$urlActivation = EWPHelper::getViewUrl(Globalselementwidgetpro::VIEW_LICENSE_ELEMENTOR);
	...
	protected function putPopupForm(){
		...
		?>
		<span class="activate-license unlimited_elementor_elements_for_elementor">
	...
	private function initByFreemius(){
		...
		$urlCCodecanyon = EWPHelper::getViewUrl(Globalselementwidgetpro::VIEW_LICENSE_ELEMENTOR, "envato=true");
	...
	public function __construct(){
		...
		$this->textActivate = esc_html__("Activate Unlimited Elements", "unlimited_elementor_elements");
		
		$this->urlPricing = Globalselementwidgetpro::LINK_BUY;
		
		$this->textPlaceholder = esc_html__("xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx","unlimited_elementor_elements");
		
		$this->textUnleash = esc_html__("Unleash access to +700 widgets for Elementor", "unlimited_elementor_elements");
		...
		$this->textYourProAccountLifetime = esc_html__("Unlimited Elements is activated lifetime for this site!", "unlimited_elementor_elements");
	...
	private function putFsScripts(){
		 ...
		 $moduleID = Globalselementwidgetpro::FREEMIUS_PLUGIN_ID;
	...
	public function putHtmlDeactivate(){
		...
		<span class="activate-license unlimited_elementor_elements_for_elementor">
	         ...
	         <a href="javascript:void(0)" class="unite-button-primary"><?php _e("Change License", "unlimited_elementor_elements")?></a>
		</span>             
             <br>
             <br>
		<?php
...
$objLicense = new elementwidgetproLicenceView();
$objLicense->display();
