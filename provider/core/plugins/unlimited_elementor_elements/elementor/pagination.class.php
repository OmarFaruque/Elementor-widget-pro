...
class UniteCreatorElementorPagination{
	...
	private function addElementorControls_content($widget){
		...
		$widget->start_controls_section(
                ...
                'label' => esc_html__("Archive Posts Pagination", "unlimited_elementor_elements"),
                    )
         );
		...
		$widget->add_control(
			'pagination_type',
			[
				'label' => __( 'Pagination', "unlimited_elementor_elements" ),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => '',
				'options' => [
					'' => __( 'None', "unlimited_elementor_elements" ),
					'numbers' => __( 'Numbers', "unlimited_elementor_elements" ),
					//'prev_next' => __( 'Previous/Next', "unlimited_elementor_elements" ),
					//'numbers_and_prev_next' => __( 'Numbers', "unlimited_elementor_elements" ) . ' + ' . __( 'Previous/Next', "unlimited_elementor_elements" ),
				],
			]
		);
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Page Limit', "unlimited_elementor_elements" ),
				'default' => '5',
				'condition' => [
					'pagination_type!' => '',
				],
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Shorten', "unlimited_elementor_elements" ),
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Previous Label', "unlimited_elementor_elements" ),
				'default' => __( '&laquo; Previous', "unlimited_elementor_elements" ),
				'condition' => [
					'pagination_type' => [
						'prev_next',
						'numbers_and_prev_next',
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Next Label', "unlimited_elementor_elements" ),
				'default' => __( 'Next &raquo;', "unlimited_elementor_elements" ),
				'condition' => [
					'pagination_type' => [
						'prev_next',
						'numbers_and_prev_next',
		...
		$widget->add_control(
			'pagination_align',
			[
				'label' => __( 'Alignment', "unlimited_elementor_elements" ),
				'type' => \Elementor\Controls_Manager::CHOOSE,
				'options' => [
					'left' => [
						'title' => __( 'Left', "unlimited_elementor_elements" ),
						'icon' => 'fa fa-align-left',
					],
					'center' => [
						'title' => __( 'Center', "unlimited_elementor_elements" ),
						'icon' => 'fa fa-align-center',
					],
					'right' => [
						'title' => __( 'Right', "unlimited_elementor_elements" ),
	...
	private function addElementorControls_styles($widget){
		...
		$widget->add_control(
			...
			[
				'label' => __( 'Colors', "unlimited_elementor_elements" ),
		...
		$widget->start_controls_tab(
			...
			[
				'label' => __( 'Normal', "unlimited_elementor_elements" ),
			]
		);
		...
		$widget->add_control(
			'pagination_color',
			[
				'label' => __( 'Color', "unlimited_elementor_elements" ),
		...
		$widget->start_controls_tab(
			...
			[
				'label' => __( 'Hover', "unlimited_elementor_elements" ),
			]
		);
		...
		$widget->start_controls_tab(
			...
			[
				'label' => __( 'Active', "unlimited_elementor_elements" ),
			]
		);
		...
		$widget->add_responsive_control(
			'pagination_spacing',
			[
				'label' => __( 'Space Between', "unlimited_elementor_elements" ),
	...
	public function getHTMLPaginationByElementor($arrValues){
		...
		//$options["mid_size"] = 2;
		//$options["prev_text"] = __( 'Newer', "unlimited_elementor_elements");
		//$options["next_text"] = __( 'Older', "unlimited_elementor_elements");
		//$options["total"] = 10;
		//$options["current"] = 3;
