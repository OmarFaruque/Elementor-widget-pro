	...
	class UniteSettingsUC{
		...
		public function loadXMLFile($filepath, $loadedSettingsType = null){
			...
			if( function_exists("simplexml_load_file") == false)
				UniteFunctionsUC::throwError("Your php missing SimpleXML Extension. Blox can't work without this extension because it has many xml files to load. Please enable this extension in php.ini");
