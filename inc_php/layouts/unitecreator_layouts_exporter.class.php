...
class UniteCreatorLayoutsExporterWork extends UniteCreatorExporterBase{
	...
	const IMAGES_IMPORT_FOLDER = "blox_page_builder";
	...
	protected $pathImportLayoutAddons, $arrImportImages, $importParams;
	 ...
	 * put layout addons
	 */
	protected function putLayoutAddons($arrAddons = null){
	...
	private function a_EXPORT_IMAGES(){}
	 ...
	 */
	private function processConfigImage($urlImage, $forceSaveFilename = null){
	 ...
	 */
	private function addLayoutPreviewImage(){
	...
	private function a_IMPORT_IMAGES(){}
