...
class UniteCreatorBrowserWork extends HtmlOutputBaseUC{
	 ...
	 */
	public function getCatalogAddonStateData($state, $isPage = false, $urlPreview = null, $addon = array()){
		...
		if(empty($urlPreview) && !empty($this->urlPreviewTemplate)){
